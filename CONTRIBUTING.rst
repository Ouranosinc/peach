...
#. For changes to the required packages, we suggest adding a minor/patch version to environment.yml, and, before running your tests, updating your environment with::
...
#. The pull request should work for Python 3.11. Check that the tests pass for all supported Python versions.
