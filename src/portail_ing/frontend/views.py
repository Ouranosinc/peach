...
class IndicatorDAViewer(Viewer):
    ...
    def period_span(self):
        ...
        start = dt.datetime(self.ind.period[0], 1, 1)
        end = dt.datetime(self.ind.period[1], 12, 31)
    ...
    @pn.depends("ind.period")
    def hist_view_caption(self):
        """Caption for the PDF and histogram"""
        return pn.pane.Markdown(self.ind.hist_caption, width=self.rw)
