...
class TestIndicatorBaseIDF:
    def test_simple(self):
        ...
        assert indC.to_dict()["params"]["duration"] == "2h"
...
class TestIndicatorDA:
    def test_simple(self, synthetic_dataset):
...
class TestHazard:
    def test_threshold(self, synthetic_dataset, synthetic_dataset_fut):
    ...
    def test_matrix(self, synthetic_dataset, synthetic_dataset_fut, station_data):
        a = p.Analysis(
